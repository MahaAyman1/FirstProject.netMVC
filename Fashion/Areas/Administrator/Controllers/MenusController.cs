...
namespace Fashion.Areas.Administrator.Controllers
{
    ...
    public class MenusController : Controller
    {
        ...
        public MenusController(FDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("MenuId,MenuName,MenuUrl")] Menu menu)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MenuId,MenuName,MenuUrl")] Menu menu)
        {
            if (id != menu.MenuId)
            {
                return NotFound();
